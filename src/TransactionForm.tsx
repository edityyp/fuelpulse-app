...
function startFastAlprLive(
  ...
  const tick = async () => {
    ...
    try {
      ...
      // Auto-stop when the same plate is detected twice.
      if (
        votes >= 2 ||
                ...
                <input
                  ...
                  onChange={async (
                    ...
                    try {
                      ...
                      notify(
                        "Plate detected with FastALPR. Check it before confirming.",
                      );
                    } catch (error) {
                      notify(
                        errorText(error),
                  ...
                  onClick={() => {
                    ...
                    voiceStop.current =
                      speak(
                        ...
                        () =>
                          notify(
                            "Microphone unavailable. Use manual entry.",
                          ),
                      );
                  }}
                >
