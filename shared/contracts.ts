...
export type Catalog = {organization:{slug:string;name:string;points_per_litre:number;reward_threshold_points:number;reward_name:string};pumps:Pump[];fuels:Fuel[];links:{pump_id:string;fuel_id:string}[]};
